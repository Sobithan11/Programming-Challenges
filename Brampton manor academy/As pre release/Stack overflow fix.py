...
Error code 1:If the file doesnt exist

Error code 2:If the loaded file cannot be read correctly 

Error code 3:If the Opcode is not in SymbolTable

Error code 4:If there is no colon after the opcode.

Error code 5:If opcode is an empty string

Error code 6:If the operand isnt an integer

Error code 7:If the number of lines stored in SourceCode[0] is empty.

Error code 8:If the number of lines stored in SourceCode[0] is empty.

Error code 9:If the number of lines stored in SourceCode[0] is empty.

Error code 10:If the operand value is 0, meaning the code hasnt been Assembled properly

Error code 11:If the opcode is "ERR", meaning there is an error.
"""
